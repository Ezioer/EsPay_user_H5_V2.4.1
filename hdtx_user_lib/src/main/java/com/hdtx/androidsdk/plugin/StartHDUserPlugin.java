...
import com.hdtx.androidsdk.ui.FloatView;
import com.hdtx.androidsdk.util.AES;
import com.hdtx.androidsdk.util.CommonUtils;
import com.hdtx.androidsdk.util.HDSdkLog;
import com.hdtx.androidsdk.util.FileHelper;
import com.hdtx.androidsdk.util.HostRequestUtils;
import com.hdtx.androidsdk.util.NetworkUtils;
...
public class StartHDUserPlugin {
...
//		StartOtherPlugin.logGDTActionRegister();
    ...
    public static void getH5UserInfo() {
        HDUserWebActivity.clientToJS(Constant.YSTOJS_GET_USERINFO, null);
    }
    ...
    public static void postTime() {
        HDUserWebActivity.clientToJS(Constant.YSTOJS_UPLOAD_TIME, null);
        HDUserWebActivity.clientToJS(Constant.YSTOJS_GAME_INTOFOREGROUND, null);
    }
    ...
    public static void getUserCertStatus() {
        ...
        HDUserWebActivity.clientToJS(Constant.YSTOJS_IS_CERTUSER, null);
        enterH5View();
    }
    ...
    public static void showUserCert() {
        ...
        HDUserWebActivity.clientToJS(Constant.YSTOJS_USERCERT, null);
        enterH5View();
    }
    ...
    public static void showSdkView() {
        ...
        HDUserWebActivity.clientToJS(Constant.YSTOJS_CLICK_FLOATVIEW, null);
        enterH5View();
    }
    ...
    public static void changeAccount() {
        showSdkView();
        HDUserWebActivity.clientToJS(Constant.YSTOJS_GAME_LOGOUT, null);
    }
