...
public class HDToast {
    private static com.hdtx.androidsdk.ui.HDToast toastUtils;
    ...
    public static com.hdtx.androidsdk.ui.HDToast getInstance() {
        if (toastUtils == null) {
            toastUtils = new com.hdtx.androidsdk.ui.HDToast();
        }
        return toastUtils;
    }

    public void ToastShow(Context context, String tvString) {
        View layout = LayoutInflater.from(context).inflate(context.getResources().getIdentifier("hd_toast_dialog", "layout", context.getPackageName()), null);
