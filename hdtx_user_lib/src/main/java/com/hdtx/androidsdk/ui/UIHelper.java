...
import com.hdtx.androidsdk.util.UnitUtils;
...
public class UIHelper {
    ...
    public static LinearLayout createBar(final Context context, final Handler handler) {
        ...
        layout.setBackgroundResource(context.getResources().getIdentifier("hd_alertview_title_bg", "drawable",
                context.getPackageName()));
//		layout.setBackgroundDrawable(CommonUtils.getNinePatchDrawable(context, "hd_alertview_title_bg.9.png"));
...
//		layout.setBackgroundDrawable(new BitmapDrawable(context.getResources(), main_bg_Img));
    ...
    public static View createPayView(final Context context, final Handler handler, Map<String, String> map) {
        ...
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        convertView = inflater.inflate(
                context.getResources().getIdentifier("hd_opt_pannel", "layout", context.getPackageName()),
                null);
        ...
        tv_title.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                HDToast.getInstance().ToastShow(context, "version:" + Constant.SDK_VERSION);
                return false;
            }
        });
...
//				ylImageViewid.setVisibility(View.VISIBLE);
        ...
        // 支付金额
        String money = map.get(HDConstant.MONEY);
    ...
    public static class Pay_List_Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
                convertView = inflater.inflate(
                        context.getResources().getIdentifier("hd_paylist_item", "layout", context.getPackageName()), null);
                layout.tradeName = (TextView) convertView.findViewById(context.getResources()
                        .getIdentifier("hdtxpay_paylist_tradename", "id", context.getPackageName()));
                layout.tradeWay = (TextView) convertView.findViewById(
                        context.getResources().getIdentifier("hdtxpay_paylist_tradeway", "id", context.getPackageName()));
                layout.tradeTime = (TextView) convertView.findViewById(context.getResources()
                        .getIdentifier("hdtxpay_paylist_tradetime", "id", context.getPackageName()));
                layout.titleAmt = (TextView) convertView.findViewById(
                        context.getResources().getIdentifier("hdtxpay_paylist_amt", "id", context.getPackageName()));
                layout.titlePoint = (TextView) convertView.findViewById(
                        context.getResources().getIdentifier("hdtxpay_paylist_point", "id", context.getPackageName()));
