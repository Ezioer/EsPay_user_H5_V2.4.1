...
public class NotiDialog extends Dialog {
    ...
    private String mUserService = "https://egamec.ssov2.szzkxkj.com/pro_user.html";
    private String mPrivate = "https://egamec.ssov2.szzkxkj.com/prot.html";
    ...
    private String mNoti = "欢迎下载本游戏，我们非常重视个人信息和隐私保护。\n" +
            ...
            "3、我们可能会申请获取设备IMSI/IMEI号：提供读取手机设备标识等信息，请您放心，该权限无法监听、获取您的任何通话内容与信息；使用场景或目的：读取设备通话状态和识别码，识别手机设备ID（IMEI/android ID/DEVICE_ID/IDFA、OAID、MAC地址），保证运营商网络免流服务，用于完成音视频、信息展示、帐号登录、安全保障等主要功能。\n" +
            "4、在您的设备配置支持的情况下，为实现游戏内场景画面的动画显示效果，进行辅助定位，我们会收集您设备的传感器信息（视不同的场景，分别收集加速度传感器、重力传感器、旋转矢量传感器、磁场传感器以及陀螺仪传感器信息）\n" +
