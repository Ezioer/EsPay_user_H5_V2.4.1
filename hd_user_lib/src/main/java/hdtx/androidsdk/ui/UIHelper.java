...
import hdtx.androidsdk.data.PayItem;
import hdtx.androidsdk.util.ESdkLog;
import hdtx.androidsdk.util.UnitUtils;
...
//				ylImageViewid.setVisibility(View.VISIBLE);
        ...
        userID = (TextView) convertView
                .findViewById(context.getResources().getIdentifier("hd_userID", "id", context.getPackageName()));
        userID.setText(String.valueOf(Constant.ESDK_USERID));

        // 购买商品
        titleBuyInfo = (TextView) convertView.findViewById(
                context.getResources().getIdentifier("hd_id_tittleOfferName", "id", context.getPackageName()));
        titleBuyInfo.setText(map.get(Constant.PRODUCT_NAME));
        tittleInfo = (TextView) convertView.findViewById(
                context.getResources().getIdentifier("hd_id_tittleMount", "id", context.getPackageName()));
        ...
        tittleAmt = (TextView) convertView.findViewById(
                context.getResources().getIdentifier("hd_id_tittleAmt", "id", context.getPackageName()));
